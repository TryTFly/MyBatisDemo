...
<body style="background: #e1e9eb;">
	<h1><%=basePath%>resources/css/all.css
	</h1>
	<h2>${pageContext.request.contextPath}/resources/css/all.css</h2>
	<form action="<%=basePath%>ListServlet.action" id="mainForm"
		...
		<div class="right">
			...
			<div class="rightCont">
				<p class="g_title fix">
					内容列表 <a class="btn03"
						href="<%=basePath%>InsertControllerServlet.action">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
						...
						<tbody>
							...
							<c:forEach items="${messageList}" var="message"
								...
								<tr
									...
									<td><a href="#">修改</a>&nbsp;&nbsp;&nbsp; <a
										href="<%=basePath %>DeleteOneServlet?id=${message.id}"
										onclick="elementsChange()">删除</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
